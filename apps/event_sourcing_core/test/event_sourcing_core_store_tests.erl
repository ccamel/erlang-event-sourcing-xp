...
persist_single_event(Store) ->
    ...
    Event =
        event_sourcing_core_store:new_event(stream_A,
                                            user,
                                            user_registered,
                                            1,
                                            Timestamp,
...
persist_2_streams_event(Store) ->
    ...
    EventStreamA =
        [event_sourcing_core_store:new_event(stream_A,
                                             ...
                                             {"John Doe"})],
    EventStreamB =
        [event_sourcing_core_store:new_event(stream_B,
                                             user,
                                             user_registered,
                                             1,
                                             Timestamp,
...
fetch_streams_event(Store) ->
    ...
    ?assertMatch([Event2],
                 event_sourcing_core_store:retrieve_events(Store,
                                                           stream_A,
                                                           #{from => 2,
                                                             to => 4,
                                                             limit => 1})),
